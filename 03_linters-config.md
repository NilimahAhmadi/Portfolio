...
Linters are tools that analyze your source code to flag programming errors, bugs, stylistic errors, and suspicious constructs. They can help you write better code and catch simple mistakes like typos. This folder contains configuration files for linters and validators that you can use in your projects.
...
- [html&css](./html-css/README.md) (for projects that require you to use HTML & CSS)
- [html&css + javascript](./html-css-js/README.md) (for projects that require you to use both JavaScript and HTML & CSS)
- [javascript](./javascript/README.md) (for projects that require you to use JavaScript)
- [react&redux](./react-redux/README.md) (for projects that require you to use React & Redux)
